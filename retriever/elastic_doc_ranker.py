...
class ElasticDocRanker(object):
    ...
    def get_doc_id(self, doc_index):
        ...
        return retriever_utils.get_field(source, self.elastic_field_doc_name)
    ...
    def closest_docs(self, query, k=1):
        ...
        doc_ids = [retriever_utils.get_field(row['_source'], self.elastic_field_doc_name) for row in hits]
    ...
    def get_doc_ids(self):
        ...
        results = self.es.search(index= self.elastic_index, body={
            "query": {"match_all": {}}})
        doc_ids = [retriever_utils.get_field(result['_source'], self.elastic_field_doc_name) for result in results['hits']['hits']]
        return doc_ids
